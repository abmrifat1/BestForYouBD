                        ...
                        <table class="table table-hover">
                            ...
                            <tr v-for="department in departments.data" :key="department.id">
                                ...
                                <td>
                                    ...
                                    <a href="#" @click="deleted(department.id)" v-if="$gate.isAdminOrAuthor()">
...
<script>
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get('api/admin-department?page=' + page)
                    .then(response => {
            ...
            update(){
                this.$Progress.start();
                this.form.put('api/admin-department/'+this.form.id)
                    .then(() => {
                        $('#addNew').modal('hide');
                        swal(
                            'Updated!',
            ...
            create(){
                this.$Progress.start();
                this.form.post('api/admin-department')
                .then(()=>{
                    Fire.$emit('takePageLoad');
                    $('#addNew').modal('hide');
                    toast({
            ...
            deleted(id){
                ...
                swal({
                    ...
                    if(result.value){
                        this.form.delete('api/admin-department/'+id).then(()=>{
                            swal(
                                'Deleted!',
