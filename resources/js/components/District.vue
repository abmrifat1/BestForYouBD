            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" v-show="editMode" id="addNewLabel">Update cities Info</h5>
...
<script>
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get('api/admin-city?page=' + page)
                    .then(response => {
            ...
            update(){
                this.$Progress.start();
                this.form.put('api/admin-city/'+this.form.id)
                    .then(() => {
                        $('#addNew').modal('hide');
                        swal(
                            'Updated!',
            ...
            load(){
                ...
                if(this.$gate.isAdminOrAuthor()){
                    axios.get("api/admin-city").then(({ data }) => (this.cities = data));
                }
                this.$Progress.finish();
            },
            create(){
                this.$Progress.start();
                this.form.post('api/admin-city')
                .then(()=>{
                    Fire.$emit('takePageLoad');
                    $('#addNew').modal('hide');
                    toast({
            ...
            deleted(id){
                ...
                swal({
                    ...
                    if(result.value){
                        this.form.delete('api/admin-city/'+id).then(()=>{
                            swal(
                                'Deleted!',
